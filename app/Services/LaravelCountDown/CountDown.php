...
namespace App\Services\LaravelCountDown;

use Exception;
use Carbon\Carbon;
use DateTimeInterface;
use App\Exceptions\InvalidDateFormatToCountDown;
use App\Exceptions\InvalidPropertyStringForHumanException;
...
class CountDown
{
     ...
     * @throws \App\Exceptions\InvalidPropertyStringForHumanException
     * @return string
     */
