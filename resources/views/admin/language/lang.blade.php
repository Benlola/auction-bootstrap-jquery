            ...
            <div class="modal-content">
                ...
                <form method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mt-2">
                            <label for="inputName" class="font-weight-bold">@lang('Rtl') <span class="text-danger">*</span></label>
                            <input type="checkbox" data-width="100%" data-height="40px" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" data-on="@lang('SET')" data-off="@lang('UNSET')" name="is_rtl">
                        </div>
                    </div>
                    <div class="modal-footer">
