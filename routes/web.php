...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::post('merchant/send-email/{id}', 'ManageMerchantsController@sendEmailSingle')->name('merchants.email.single.send');
        ...
        Route::post('merchant-profile', 'GeneralSettingController@merchantProfileSubmit')->name('merchant.profile.submit');
